...
public class CAIdentifierDescriptorPayloadNodeBuilder extends DescriptorPayloadNodeBuilder
{
    @Override
    public void build(DefaultMutableTreeNode node, Encoding payload)
    {
        ...
        {
            node.add(create(String.format("CA系统号%d = 0x%04X", i + 1, payload.readUINT16(i * 2))));
        }
    }
}
