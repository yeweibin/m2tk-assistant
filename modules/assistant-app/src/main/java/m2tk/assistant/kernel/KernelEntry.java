...
public class KernelEntry
{
    ...
    @Bean
    public StreamAnalyzer streamAnalyzer(@Inject EventBus bus, @Inject M2TKDatabase database)
    {
        return new StreamAnalyzer(bus, database);
    }
}
