...
public class ISO639LanguageDescriptorPayloadNodeBuilder extends DescriptorPayloadNodeBuilder
{
    ...
    public void build(DefaultMutableTreeNode node, Encoding payload)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            int audioType = payload.readUINT8(i * BLOCK_SIZE + 3);
            ...
            nodeDesc.add(create(String.format("audio_type = %s", translateAudioType(audioType))));
            node.add(nodeDesc);
        }
    }
