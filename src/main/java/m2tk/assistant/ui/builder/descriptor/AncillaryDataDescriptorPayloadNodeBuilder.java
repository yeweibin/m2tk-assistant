...
public class AncillaryDataDescriptorPayloadNodeBuilder extends DescriptorPayloadNodeBuilder
{
    @Override
    public void build(DefaultMutableTreeNode node, Encoding payload)
    {
        int identifier = payload.readUINT8(0);
        String text = String.format("ancillary_data_identifier = '%s'", eightBits(identifier));
